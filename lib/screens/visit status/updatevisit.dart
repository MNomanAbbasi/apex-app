...
class updatevisit extends StatefulWidget {
  final String id;
  updatevisit({Key? key, required this.id}) : super(key: key);

  @override
  _UpdateStudentPageState createState() => _UpdateStudentPageState();
}

class _UpdateStudentPageState extends State<updatevisit> {
